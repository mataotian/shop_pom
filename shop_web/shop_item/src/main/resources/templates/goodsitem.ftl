...
<div class="shop_goods_bd clear">
    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="http://192.168.126.129/${images[0]}" jqimg="http://192.168.126.129/${images[0]}" width="350">
                </div>
                <div id="spec-n5">
                    ...
                    <div id="spec-list">
                        <ul class="list-h">
                            ...
                            <li><img src="http://192.168.126.129/${image}"> </li>
                            </#list>
                        </ul>
                    </div>
